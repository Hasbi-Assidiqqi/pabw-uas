            ...
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <!-- cctv -->
                        <li class="nav-item">
                            <a href="cctv.php" class="nav-link active">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <a href="create-cctv.php" class="btn btn-primary" style="margin-bottom:5px;">Tambah Data</a>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">CCTV Kabupaten Bengkalis</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $i=1;
                                            $koneksi = koneksiUas();
                                            $data = mysqli_query($koneksi, "SELECT * FROM cctv ORDER BY id DESC");
                                            while ($row = mysqli_fetch_array($data)){
                                            ?>
                                            <tr>
                                                <td><?= $i;?></td>
                                                <td>
                                                    <iframe height="160" src="<?= $row['link'];?>" frameborder="0"
                                                ...
                                                <td><?= $row['deskripsi'];?> </td>
                                                <td>
                                                    <a href="update-cctv.php?&id=<?= $row["id"]; ?>"
                                                        class="btn btn-info">Ubah</a>
                                                    <a href="delete-cctv.php?&id=<?= $row["id"];?>" <a
                                                        href="delete-cctv.php?&id=<?= $row["id"];?>"
