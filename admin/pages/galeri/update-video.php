...
$id = $_GET["id"];
$sql = "SELECT * FROM galeri_video WHERE id=". $id;
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Ubah Video Kabupaten Bengkalis</h3>
                                </div>
                                <div class="card-body">
                                    <?php
                                    ...
                                    <form role="form" method="POST" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <video height="160" controls>
                                                <source src="../../dist/videos/<?= $row["video"];?>" type="video/mp4">
                                                <source src="../../dist/videos/<?= $row["video"];?>" type="video/webm">
                                                <source src="../../dist/videos/<?= $row["video"];?>" type="video/mov">
                                            </video>
                                            <br>
                                            <input style="margin-top: 12px;" class="no-outline" type="file" name="video"
                                                id="video" value="<?=$sql["video"];?>" required />
                                        </div>
                                        <div class="form-group">
                                            <label>Judul</label>
