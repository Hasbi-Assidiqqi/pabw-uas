...
$id = $_GET["id"];
$sql = "SELECT * FROM kontak_masuk WHERE id=". $id;

$data = mysqli_query($koneksi,$sql);

if(isset($_POST["update"])){
    if(updateKontakMasuk($_POST) > 0){
        echo"<script>
        alert('data berhasil di ubah !');
        document.location.href='kontak-masuk.php';
        </script>";
    }
    else{
        echo "<script>
            ...
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <!-- kontak masuk -->
                        <li class="nav-item">
                            <a href="kontak-masuk.php" class="nav-link active">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Ubah Kontak Masuk Kabupaten Bengkalis</h3>
                                </div>
                                <div class="card-body">
                                    <?php
                                    ...
                                    <form role="form" method="POST" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="tipe">
                                                ...
                                                <option value="Pengaduan"
                                                    <?php if ($sql['tipe'] == 'Pengaduan'){echo 'selected';} ?>>
                                                    Pengaduan
                                                </option>
                                                <option value="Aspirasi"
                                                    <?php if ($sql['tipe'] == 'Aspirasi'){echo 'selected';} ?>>
                                                    Aspirasi</option>
                                                <option value="Permohonan"
                                                    <?php if ($sql['tipe'] == 'Permohonan'){echo 'selected';} ?>>
                                                    Permohonan</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label>Pesan</label>
                                                <br>
                                                <textarea class="ckeditor" name="pesan" id="pesan" cols="30"
                                                    rows="10"></textarea>
                                            </div>
                                            <div>
                                                <input class="btn btn-primary" type="submit" name="update" Value="Ubah"
                                                    onclick="return confirm('yakin data diubah');"
