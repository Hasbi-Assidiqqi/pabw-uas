        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <a href="create-kontak-masuk.php" class="btn btn-primary" style="margin-bottom:5px;">Tambah Data</a>
                </div>
            </div>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['pesan'];?> </td>
                                                <td>
                                                    <a href="update-kontak-masuk.php?&id=<?= $row["id"]; ?>"
                                                        class="btn btn-info">Ubah</a>
                                                    <a href="delete-kontak-masuk.php?&id=<?= $row["id"];?>"
