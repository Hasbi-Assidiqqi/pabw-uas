...
$id = $_GET["id"];
$sql = "SELECT * FROM statistik_perkawinan WHERE id=". $id;

$data = mysqli_query($koneksi,$sql);

if(isset($_POST["update"])){
    if(updateStatistikPerkawinan($_POST) > 0){
        echo"<script>
        alert('data berhasil di ubah !');
        document.location.href='perkawinan.php';
        </script>";
    }
    else{
        echo "<script>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Ubah Perkawinan Kabupaten Bengkalis</h3>
                                </div>
                                <div class="card-body">
                                    <?php
