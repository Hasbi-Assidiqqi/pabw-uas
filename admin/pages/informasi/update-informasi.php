                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Ubah Informasi Kabupaten Bengkalis</h3>
                                </div>
                                <div class="card-body">
                                    <?php
                                    ...
                                    <form role="form" method="POST" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>Link</label>
                                            <input class="form-control" name="link" id="link" value="<?=$sql["link"];?>"
                                                required />
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="target">
                                                ...
                                                <option value="_self"
                                                    <?php if ($sql['target'] == '_self'){echo 'selected';} ?>>
                                                    This Window
                                                </option>
                                                <option value="_blank"
                                                    <?php if ($sql['target'] == '_blank'){echo 'selected';} ?>>
                                                    New Window</option>
                                            </select>
                                        </div>
                                        <div>
