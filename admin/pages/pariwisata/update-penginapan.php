...
if(isset($_POST["update"])){
    if(updatePenginapan($_POST) > 0){
        echo"<script>
        alert('data berhasil di ubah !');
        document.location.href='penginapan.php';
        </script>";
    }
    else{
        echo "<script>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Ubah Penginapan Kabupaten Bengkalis</h3>
                                </div>
                                <div class="card-body">
                                    <?php
                                    ...
                                    <form role="form" method="POST" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>Foto</label>
                                            <br>
                                            <img src="../../dist/images/<?=$sql["gambar"];?>" style="width: 20%;"
                                                alt="">
                                            <br>
                                        ...
                                        <div class="form-group">
                                            <label>Nama</label>
                                            <input class="form-control" name="nama" id="nama" value="<?=$sql["nama"];?>"
                                                required />
                                        </div>
                                        <div class="form-group">
                                            <label>Lokasi</label>
