        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <a href="create-penginapan.php" class="btn btn-primary" style="margin-bottom:5px;">Tambah Data</a>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Penginapan Kabupaten Bengkalis</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $i=1;
                                            $koneksi = koneksiUas();
                                            $data = mysqli_query($koneksi, "SELECT * FROM penginapan ORDER BY id DESC");
                                            while ($row = mysqli_fetch_array($data)){
                                            ?>
                                            <tr>
                                                <td><?= $i;?></td>
                                                <td><img src="../../dist/images/<?= $row['gambar'];?>" alt=""
                                                ...
                                                <td><?= $row['rating'];?> </td>
                                                <td>
                                                    <a href="update-penginapan.php?&id=<?= $row["id"]; ?>"
                                                        class="btn btn-info">Ubah</a>
                                                    <a href="delete-penginapan.php?&id=<?= $row["id"];?>"
