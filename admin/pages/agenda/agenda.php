        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <a href="create-agenda.php" class="btn btn-primary" style="margin-bottom:5px;">Tambah Data</a>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Agenda Kabupaten Bengkalis</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $i=1;
                                            $koneksi = koneksiUas();
                                            $data = mysqli_query($koneksi, "SELECT * FROM agenda ORDER BY id DESC");
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['tanggal'];?> </td>
                                                <td>
                                                    <a href="update-agenda.php?&id=<?= $row["id"]; ?>"
                                                        class="btn btn-info">Ubah</a>
                                                    <a href="delete-agenda.php?&id=<?= $row["id"];?>"
