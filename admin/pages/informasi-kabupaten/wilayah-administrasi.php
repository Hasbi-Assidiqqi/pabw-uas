        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <a href="create-wilayah-administrasi.php" class="btn btn-primary" style="margin-bottom:5px;">Tambah
                        Data</a>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Wilayah Administrasi Kabupaten Bengkalis</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $i=1;
                                            $koneksi = koneksiUas();
                                            $data = mysqli_query($koneksi, "SELECT * FROM wilayah_administrasi ORDER BY id DESC");
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['penduduk'];?> </td>
                                                <td>
                                                    <a href="update-wilayah-administrasi.php?&id=<?= $row["id"]; ?>"
                                                        class="btn btn-info">Ubah</a>
                                                    <a href="delete-wilayah-administrasi.php?&id=<?= $row["id"];?>"
