                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Ubah Wilayah Administrasi Kabupaten Bengkalis</h3>
                                </div>
                                <div class="card-body">
                                    <?php
                                    ...
                                    <form role="form" method="POST" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>Program</label>
                                            <input class="form-control" name="program" id="program"
                                                value="<?=$sql["program"];?>" />
                                        </div>
                                        <div class="form-group">
                                            <label>Asal Dana</label>
                                            <input class="form-control" name="asal_dana" id="asal_dana"
                                                value="<?=$sql["asal_dana"];?>" />
                                        </div>
                                        <div class="form-group">
                                            <label>Peserta</label>
                                            <input class="form-control" name="peserta" id="peserta"
                                                value="<?=$sql["peserta"];?>" />
                                        </div>
                                        <div class="form-group">
                                            <label>Sasaran</label>
                                            <input class="form-control" name="sasaran" id="sasaran"
                                                value="<?=$sql["sasaran"];?>" />
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status">
                                                ...
                                                <option value="Aktif"
                                                    <?php if ($sql['status'] == 'Aktif'){echo 'selected';} ?>>
                                                    Aktif
                                                </option>
                                                <option value="Non-Aktif"
                                                    <?php if ($sql['status'] == 'Non-Aktif'){echo 'selected';} ?>>
                                                    Non Aktif</option>
                                            </select>
                                        </div>
                                        <div>
