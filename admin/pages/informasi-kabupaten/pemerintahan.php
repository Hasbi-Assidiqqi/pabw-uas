        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <a href="create-pemerintahan.php" class="btn btn-primary" style="margin-bottom:5px;">Tambah Data</a>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Pemerintahan Kabupaten Bengkalis</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $i=1;
                                            $koneksi = koneksiUas();
                                            $data = mysqli_query($koneksi, "SELECT * FROM pemerintahan ORDER BY id DESC");
                                            while ($row = mysqli_fetch_array($data)){
                                            ?>
                                            <tr>
                                                <td><?= $i;?></td>
                                                <td>
                                                    <img src="../../dist/images/<?= $row['gambar'];?>" alt=""
                                                        height="100px" width="180">
                                                </td>
                                                <td><?= $row['nama'];?> </td>
                                                <td><?= $row['ttl'];?> </td>
                                                <td><?= $row['jabatan'];?> </td>
                                                ...
                                                <td><?= $row['periode_jabatan'];?> </td>
                                                <td>
                                                    <a href="update-pemerintahan.php?&id=<?= $row["id"]; ?>"
                                                        class="btn btn-info">Ubah</a>
                                                    <a href="delete-pemerintahan.php?&id=<?= $row["id"];?>"
