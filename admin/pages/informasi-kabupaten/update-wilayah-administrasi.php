...
$id = $_GET["id"];
$sql = "SELECT * FROM wilayah_administrasi WHERE id=". $id;

$data = mysqli_query($koneksi,$sql);

if(isset($_POST["update"])){
    if(updateWilayahAdministrasi($_POST) > 0){
        echo"<script>
        alert('data berhasil di ubah !');
        document.location.href='wilayah-administrasi.php';
        </script>";
    }
    else{
        echo "<script>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form role="form" method="POST" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>RW</label>
                                            <input class="form-control" name="rw" id="rw" value="<?=$sql["rw"];?>" />
                                        </div>
                                        <div class="form-group">
                                            <label>RT</label>
                                            <input class="form-control" name="rt" id="rt" value="<?=$sql["rt"];?>" />
                                        </div>
                                        <div class="form-group">
                                            <label>Penduduk</label>
                                            <input class="form-control" name="penduduk" id="penduduk"
                                                value="<?=$sql["penduduk"];?>" />
                                        </div>
                                        <div>
