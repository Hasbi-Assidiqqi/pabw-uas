...
if(isset($_POST["create"])){
    if(createIdentitas($_POST) > 0){
        echo"<script>
        alert('data berhasil di tambahkan !');
        document.location.href='identitas.php';
        </script>";
    }
    else{
        echo "<script>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Tambah Identitas Kabupaten Bengkalis</h3>
                                </div>
                                <div class="card-body">
                                    <form role="form" method="POST" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>Isi</label>
                                            <textarea class="ckeditor" name="isi" id="isi" cols="30"
                                                rows="10"></textarea>
                                        </div>
                                        <div>
