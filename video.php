        ...
        <div class="col-md-8">
            ...
            <section id="news-main">
                <div class="row">
                    ...
                    $data = mysqli_query($koneksi,"SELECT * FROM galeri_video");
                    $jumlah_data = mysqli_num_rows($data);
                    $total_halaman = ceil($jumlah_data / $batas);

                    $data_galeri = mysqli_query($koneksi,"SELECT * FROM galeri_video ORDER BY id DESC LIMIT $halaman_awal, $batas");
                    ...
                    <div class="col-md-4">
                        <div>
                            <video controls style="width:100%; height: 170px;">
                                <source src="admin/dist/videos/<?= $sql['video'];?>" type="video/mp4">
                            </video>
                            <p><?= $sql['judul'];?></p>
                        </div>
                    </div>
            ...
            <div class="card my-4">
                ...
                <div class="card-body">
                    <div class="paginition left">
                        <ul>
                            <li style="width: 47%;"><a href="foto.php">Foto</a></li>
                            <li class="active" style="width: 47%;"><a href="video.php">Video</a></li>
                        </ul>
                    </div>
                </div>
            </div>
