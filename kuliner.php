...
<head>
    ...
    <title>Kuliner Kabupaten Bengkalis</title>
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="title">
                <h3>KULINER <span>BENGKALIS</span></h3>
                <hr>
            </div>
            ...
            <section id="news-main">
                <div class="row">
                    ...
                    $data_kuliner= mysqli_query($koneksi,"SELECT * FROM kuliner ORDER BY id DESC LIMIT $halaman_awal, $batas");
                    $nomor = $halaman_awal+1;
                    while ($sql = mysqli_fetch_array($data_kuliner)){
                    ?>
                    <div class="col-md-4">
                        <div class="galeri">
                ...
                <div class="card-body">
                    <div class="paginition left">
                        <ul>
                            ...
                            <li class="active" style="width: 30%;"><a href="kuliner.php">Kuliner</a></li>
                            <li style="width: 30%;"><a href="penginapan.php">Penginapan</a></li>
                        </ul>
                    </div>
                </div>
            </div>
