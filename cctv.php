...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="title">
                <h3>CCTV <span>BENGKALIS</span></h3>
                <hr>
            </div>
            ...
            $i=0;
            $koneksi = koneksiUas();
            $data = mysqli_query($koneksi, "SELECT * FROM cctv ORDER BY id ASC LIMIT 0,1");
            while ($row = mysqli_fetch_array($data)){
            ?>
            <div class="card mb-4 box-shadow">
                <iframe class="main-cctv" src="<?= $row['link'];?>" frameborder="0"
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <iframe width="560" height="315" src="<?= $row['link'];?>" frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowfullscreen></iframe>
                        <div class="card-body">
                            <p class="card-text"><?= $row['deskripsi'];?></p>
