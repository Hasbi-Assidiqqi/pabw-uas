...
<head>
    ...
    <title>Identitas Kabupaten Bengkalis</title>
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="title">
                <h3>IDENTITAS <span>BENGKALIS</span></h3>
                <hr>
            </div>

            <h2 style="text-align: center; margin: 108px 0 44px 0;">Identitas Kabupaten Bengkalis</h2>
            ...
            <table id="example" class="display responsive nowrap" style="width:100%">
                <tbody>
                    ...
                    $i=1;
                    $koneksi = koneksiUas();
                    $data = mysqli_query($koneksi, "SELECT * FROM identitas ORDER BY id ASC");
                    while ($row = mysqli_fetch_array($data)){
                    ?>
                    <tr>
                        <td data-priority="1" width="300"><?= $row['judul'];?></td>
                        <td data-priority="1" width="1">:</td>
                        <td data-priority="1" width="1"><?= $row['isi'];?></td>
                    </tr>
                    <?php
                    $i++;
                    }
