...
<head>
    ...
    <title>Penginapan Kabupaten Bengkalis</title>
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="title">
                <h3>PENGINAPAN <span>BENGKALIS</span></h3>
                <hr>
            </div>
            ...
            <section id="news-main">
                <div class="row">
                    ...
                    $data = mysqli_query($koneksi,"SELECT * FROM penginapan");
                    $jumlah_data = mysqli_num_rows($data);
                    $total_halaman = ceil($jumlah_data / $batas);

                    $data_penginapan= mysqli_query($koneksi,"SELECT * FROM penginapan ORDER BY id DESC LIMIT $halaman_awal, $batas");
                    $nomor = $halaman_awal+1;
                    while ($sql = mysqli_fetch_array($data_penginapan)){
                    ?>
                    <div class="col-md-4">
                        <div class="galeri">
                            <img src="admin/dist/images/<?= $sql['gambar'];?>" style="width:100%; height: 170px;"
                                class="img-fluid" alt="...">
                            <p><a href="<?= $sql['link'];?>" target="_blank"><?= $sql['nama'];?></a></p>
                            <fieldset class="bintang" style="margin-top: -16px; margin-bottom: 24px;">
                                <span class="starImg star-<?= $sql['rating'];?>"></span>
                            </fieldset>
                        </div>
                    </div>
                    <?php
            ...
            <div class="card my-4">
                ...
                <div class="card-body">
                    <div class="paginition left">
                        <ul>
                            <li style="width: 30%;"><a href="wisata.php">Wisata</a></li>
                            <li style="width: 30%;"><a href="kuliner.php">Kuliner</a></li>
                            <li class="active" style="width: 30%;"><a href="penginapan.php">Penginapan</a></li>
                        </ul>
                    </div>
                </div>
            </div>
