...
<head>
    ...
    <title>Bantuan Kabupaten Bengkalis</title>
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="title">
                <h3>BANTUAN <span>BENGKALIS</span></h3>
                <hr>
            </div>

            <h2 style="text-align: center; margin: 108px 0 44px 0;">Data Agama Kabupaten Bengkalis</h2>
            ...
            <table id="example" class="display responsive nowrap" style="width:100%">
                ...
                $i=1;
                $koneksi = koneksiUas();
                $data = mysqli_query($koneksi, "SELECT * FROM bantuan ORDER BY id ASC");
