...
<head>
    ...
    <title>Pemerintahan Kabupaten Bengkalis</title>
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="title">
                <h3>PEMERINTAHAN <span>BENGKALIS</span></h3>
                <hr>
            </div>
            ...
            <div class="row">
                ...
                $i=1;
                $koneksi = koneksiUas();
                $data = mysqli_query($koneksi, "SELECT * FROM pemerintahan ORDER BY id ASC");
                while ($row = mysqli_fetch_array($data)){
                ?>
                <div class="col-lg-4 mb-4">
                    <div class="card h-100 text-center">
                        <img class="card-img-top" src="admin/dist/images/<?= $row['gambar'];?>" height="300" alt="">
                        <div class="card-body">
                            <h4 class="card-title"><?= $row["nama"];?></h4>
                            <h6 class="card-subtitle mb-2 text-muted"><?= $row["jabatan"];?></h6>
                        </div>
                    </div>
                </div>
                <?php $i++;
