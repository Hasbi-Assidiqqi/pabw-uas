...
<head>
    ...
    <title>Wilayah Administrasi Kabupaten Bengkalis</title>
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="title">
                <h3>WILAYAH ADMINISTRASI <span>BENGKALIS</span></h3>
                <hr>
            </div>

            <h2 style="text-align: center; margin: 108px 0 44px 0;">Wilayah Administrasi Kabupaten Bengkalis</h2>

            <table id="example" class="display responsive nowrap" style="width:100%">
                <thead>
                    <tr>
                        <th data-priority="1">No</th>
                        <th data-priority="2">Kecamatan</th>
                        <th>Desa</th>
                        <th>Kelurahan</th>
                        <th>RW</th>
                        <th>RT</th>
                ...
                $i=1;
                $koneksi = koneksiUas();
                $data = mysqli_query($koneksi, "SELECT * FROM wilayah_administrasi ORDER BY id ASC");
