...
<head>
    ...
    <title>Wisata Kabupaten Bengkalis</title>
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="title">
                <h3>WISATA <span>BENGKALIS</span></h3>
                <hr>
            </div>
            ...
            <section id="news-main">
                <div class="row">
                    ...
                    $data_wisata= mysqli_query($koneksi,"SELECT * FROM wisata ORDER BY id DESC LIMIT $halaman_awal, $batas");
                    $nomor = $halaman_awal+1;
                    while ($sql = mysqli_fetch_array($data_wisata)){
                    ?>
                    <div class="col-md-4">
                        <div class="galeri">
            ...
            <div class="card my-4">
                ...
                <div class="card-body">
                    <div class="paginition left">
                        <ul>
                            <li class="active" style="width: 30%;"><a href="wisata.php">Wisata</a></li>
