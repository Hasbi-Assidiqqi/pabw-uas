...
<head>
    ...
    <title>Statistik Umur Kabupaten Bengkalis</title>
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <h2 style="text-align: center; margin: 108px 0 44px 0;">Data Umur Kabupaten Bengkalis</h2>

            <table id="example" class="display responsive nowrap" style="width:100%">
                <thead>
                    <tr>
                        <th data-priority="1">No</th>
                        <th data-priority="2">Umur</th>
                        <th>Laki-laki</th>
                        <th>Perempuan</th>
                        <th>Jumlah</th>
                    </tr>
                ...
                $i=1;
                $koneksi = koneksiUas();
                $data = mysqli_query($koneksi, "SELECT * FROM statistik_umur ORDER BY id ASC");
